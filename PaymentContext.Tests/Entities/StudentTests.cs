...
namespace PaymentContext.Tests
{
    ...
    public class StudentTests
    {
        ...
        public StudentTests()
        {
            ...
            _document = new Document("34170866045", EDocumentType.CPF);
            _email = new Email("teste@gmail.com");
            _address = new Address("Rua 1", "1234", "Barreiro", "Belo Horizonte", "MG", "BR", "30644160");
        ...
        [TestMethod]
        public void ShouldReturnErrorWhenActiveSubscriptionsHasNoPayment()
        {
            _student.AddSubscription(_subscription);
            Assert.IsTrue(_student.Invalid);
        }
